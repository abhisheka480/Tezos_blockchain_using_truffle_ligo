(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taquito/rpc'), require('@taquito/signer'), require('@taquito/michelson-encoder'), require('@taquito/utils'), require('rxjs'), require('rxjs/operators'), require('bignumber.js'), require('@taquito/http-utils')) :
    typeof define === 'function' && define.amd ? define(['exports', '@taquito/rpc', '@taquito/signer', '@taquito/michelson-encoder', '@taquito/utils', 'rxjs', 'rxjs/operators', 'bignumber.js', '@taquito/http-utils'], factory) :
    (global = global || self, factory(global.taquito = {}, global.rpc, global.signer, global.michelsonEncoder, global.utils, global.rxjs, global.operators, global.BigNumber, global.httpUtils));
}(this, (function (exports, rpc, signer, michelsonEncoder, utils, rxjs, operators, BigNumber, httpUtils) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var createOriginationOperation = function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var order, contractCode, contractStorage, schema, script, operation;
            return __generator(this, function (_f) {
                ...
                order = ['parameter', 'storage', 'code'];
                contractCode = Array.isArray(code)
                    ? code.sort(function (a, b) { return order.indexOf(a.prim) - order.indexOf(b.prim); }) // Ensure correct ordering for RPC
                    : utils.ml2mic(code);
    ...
    var TezosToolkit = /** @class */ (function () {
        ...
        TezosToolkit.prototype.importKey = function (privateKeyOrEmail, passphrase, mnemonic, secret) {
            return signer.importKey(this, privateKeyOrEmail, passphrase, mnemonic, secret);
        };
